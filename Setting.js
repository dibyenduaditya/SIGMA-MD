...
global.github    = 'https://github.com/dibyenduaditya/SIGMA-MD' ;
global.location  = 'Lahore, Pakistan' ;
global.website   = 'https://chat.whatsapp.com/KIks9zxaRujBqDjNEQtY29' ; 
...
global.owner = process.env.OWNER_NUMBER  || '918653805156' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "918653805156" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"Welcome to 𝐀𝐃𝐈𝐓𝐘𝐀-𝐗𝐃 𝐁𝐎𝐓 𝐎𝐅𝐂",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://www.instagram.com/i_aam_adi07' ; 
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || '[ !! < 𝐀ᴅɪᴛʏᴀ-𝐗ᴅ > !! ]',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `[ !! < 𝐌ʀ.x-𝐀ᴅɪᴛʏᴀ > !! ]`, // ADD YOUR NAME
